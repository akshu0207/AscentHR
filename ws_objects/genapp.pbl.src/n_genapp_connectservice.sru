...
Choose Case is_connectfrom
	...
	Case IS_USE_INIFILE						/*  Populate Database Connection from INI file  */
		...
		as_dbparm		= ProfileString ( ls_inifile, "Database", "DBParm", "ConnectString='DSN=akshaya_db1;UID=db1;PWD=Akshaya@123'")
	...
	Case IS_USE_REGISTRY						/*  Populate Database Connection from Registry  */
		string ls_registrykey = "HKEY_CURRENT_USER\Software\<... akshi ...>\genapp" + "\DataBase"
		...
		If RegistryGet ( ls_registrykey, "DBParm", 		RegString!, as_dbparm ) <> 1 Then
			RegistrySet ( ls_registrykey, "DBParm", 		RegString!, "ConnectString='DSN=akshaya_db1;UID=db1;PWD=Akshaya@123'" )
	...
	Case IS_USE_SCRIPT							/*  Populate Database Connection from Script  */
		...
		as_logpass		= ""
		as_server		= ""
		as_dbparm		= "ConnectString='DSN=akshaya_db1;UID=db1;PWD=Akshaya@123'"
		as_lock			= ""
		as_autocommit	= "false"
